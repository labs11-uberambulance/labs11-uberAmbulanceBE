...
| Method    | URL                 | Description                                                                                                                                                                                                      |
| --------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| TODO-POST | /api/drivers        | Include `{ location: 'lat,lng' }` in request body. Returns [nearest driver data](###Nearest-driver-data) (ref. data schema above), returns an array of the nearest active drivers with a minimum of 5.                                        |
